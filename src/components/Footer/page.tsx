import { Mail, Twitch, Twitter, ExternalLink } from "lucide-react";
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
                    ...
                    <div>
                        ...
                        <nav className="space-y-3 text-sm">
                            {[
                                ...
                                { to: "/gallery", label: "Explore Gallery" },
                ...
                <div className="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm space-y-4 md:space-y-0">
                    <div>
                        ...
                        <span className="text-white font-medium">Pepermint Gallery</span>. All rights reserved.
                    </div>
